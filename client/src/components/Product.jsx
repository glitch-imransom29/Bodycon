...
export default function Product({ link, imgSrc, price, name, onAddToCart, isInCart }) {
	return (
		<Card 
			imgSrc={imgSrc} 
			className={clsx(
    	...
    	<div className={clsx(
    		"absolute bottom-0 right-0 w-12 h-12 m-4",
    		"flex justify-center items-center",
    		"bg-black/50 font-bold text-white rounded-full text-sm",
    	)}>
    		₹{price}
    	</div>
		</Card>
